...
# font 
font TerminessTTF Nerd Font Mono 10
...
# Rofi
bindsYM $mod+d exec --no-startup-id rofi -show run -width 400 -lines 5 -font "TerminessTTF Nerd Font Mono 12" -hide-scrollbar -glob -separator-style "dash" 
...
exec feh --bg-fill ~/.config/i3/background
